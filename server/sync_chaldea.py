...
EFFECT_ALIASES_ZH = {
    ...
    "upDamage": ["特攻", "特攻伤害"],
    "addDamage": ["附加伤害"],
    "upCriticaldamage": ["暴击威力提升", "暴击伤害"],
    "upCriticalpoint": ["暴击星获取", "产星"],
    "upStarweight": ["集星权重提升", "集星"],
    "gainStar": ["获得暴击星", "给星"],
    "regainStar": ["每回合获得星"],
    "damageNpSP": ["特攻宝具"],
    "upNpdamage": ["宝具威力提升", "宝伤"],
    "gainNp": ["NP充能", "自充", "充能"],
    "regainNp": ["每回合NP回复", "NP回复"],
    "upDropnp": ["NP获取量提升"],
    "upChagetd": ["充能率提升", "超量充能"],
    "breakAvoidance": ["必中"],
    "pierceInvincible": ["无敌贯通"],
    "pierceDefence": ["防御无视"],
    "upDefence": ["防御力提升", "加防"],
    "subSelfdamage": ["被伤害减少", "减伤"],
    "avoidance": ["回避"],
    "invincible": ["无敌"],
    "guts": ["毅力", "根性"],
    "upHate": ["嘲讽", "集火"],
