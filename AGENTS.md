...
3. **如果是架构相关的重大决策**：
   - 先在 `docs/architecture-discussions/` 创建 ADR 文档
   - 记录方案对比、成本评估和决策依据
   - 方案明确后再更新到 `需求描述.md`
4. 制定实现方案，必要时与用户确认
5. 实现代码
6. 验证功能正确性
7. 更新 `MEMORY.md` 记录关键决策
8. 更新 `README.md` 保持项目说明最新
9. 更新 `PRODUCT.md` 确保用户侧功能说明最新 (非技术语言)
10. **强制：每次完成一个 Phase 或核心特性后，必须更新 `需求描述.md` 中的"产品路线图"状态，保持开发进度的一致性。**
